...
/**
 * Forum rütbesi/unvanı — postbit'te kullanıcı adının altında gösterilir.
 * $minPosts doluysa mesaj sayısına göre OTOMATİK atanır (eşiği geçen en
 * yüksek rütbe kazanılır); null ise sadece admin tarafından ELLE atanabilir
 * (ör. "Moderatör", "Kurucu" gibi mesaj sayısından bağımsız rütbeler).
 * Elle atanan rütbe, User::$data['forum_rank_id'] içinde tutulur (Cotonti
 * karşılığı: user_group / özel rütbe alanları — burada tek bir birleşik
 * rütbe modeliyle sadeleştirildi).
 */
